...
namespace CornishRoom
{
    public partial class Form1 : Form
    {
        ...
        public void BuildScene()
        {
            ...
            room.sides[0].drawing_pen = new Pen(Color.Aqua);
            room.sides[1].drawing_pen = new Pen(Color.Brown);
            room.sides[2].drawing_pen = new Pen(Color.GreenYellow);
            room.sides[3].drawing_pen = new Pen(Color.LightPink);
            ...
            Light l2 = new Light(new Point3D(-4.9f, -4.9f, 4.9f), new Point3D(1f, 1f, 1f));//белый, дальний верхний правый угол
            lights.Add(l1);
            lights.Add(l2);

            //Sphere mirrirSphere = new Sphere(new Point3D(0f, -2, 2.5f), 2.5f);
            Sphere mirrirSphere = new Sphere(new Point3D(2f, 2f, -3.95f), 1.5f);
            ...
            //bigCube.Offset(2f, 2f, -3.95f);//сдвиг по осям 
            bigCube.Offset(0f, -1, 2.5f);
            bigCube.RotateAround(70, "CZ");
            bigCube.SetPen(new Pen(Color.Gold));
            bigCube.fMaterial = new Material(0f, 0f, 0.1f, 0.7f, 1.5f);

            Figure transCube = Figure.get_Cube(2f);
            transCube.Offset(-3f, 2.5f, -3.5f);
